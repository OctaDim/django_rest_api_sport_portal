...
from apps.api.coach.settings import (AVATAR_WIDTH,
                                     AVATAR_HEIGHT,
                                     IMAGE_QUALITY,
                                     )
...
def delete_old_avatar_before_coach_save(sender, instance, **kwargs):
...
def open_resize_save_new_avatar_after_coach_saved(sender, instance, **kwargs):
...
def pre_delete_image_before_coach_delete(sender, instance, **kwargs):
    pass  # for the future purposes


@receiver(post_delete, sender=Coach)
def delete_avatar_after_coach_deleted(sender, instance, **kwargs):
