...
from apps.api.self_satisfaction_level.settings import (
                                        SATISFACTION_LEVEL_MIN_LIMIT,
                                        SATISFACTION_LEVEL_MAX_LIMIT)


def validate_satisfaction_level_value(value):
    level_min_limit = number_or_str_to_int(SATISFACTION_LEVEL_MIN_LIMIT)
    level_max_limit = number_or_str_to_int(SATISFACTION_LEVEL_MAX_LIMIT)
