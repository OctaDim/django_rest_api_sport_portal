...
from apps.api.messages_api.messages_actions import (
    COACH_SPECIALITY_CREATOR_IS_CURRENT_USER)
...
@admin.register(CoachSpeciality)  # Option 1
# admin.site.register(CoachSpeciality)  # Option 2
class CoachSpecialityAdmin(admin.ModelAdmin):
    list_display = ["id",
                    "name",
                    "description",
                    "created_at",
