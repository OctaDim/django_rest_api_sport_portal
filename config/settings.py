...
AUTHENTICATION_BACKENDS = [
    ...
    "apps.api.authentication.authentications.CustomAuthByEmailBackend",  # Custom auth by email
    "apps.api.authentication.authentications.CustomAuthByNickNameBackend",  # Custom auth by nickname
]
